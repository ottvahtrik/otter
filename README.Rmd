...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/otter)](https://CRAN.R-project.org/package=otter)
[![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
[![Codecov test coverage](https://codecov.io/gh/ottvahtrik/otter/graph/badge.svg)](https://app.codecov.io/gh/ottvahtrik/otter)
<!-- badges: end -->

otter is a small collection of functions that are useful for me, Ott, and
hopefully for others too. Sharing is caring!
...
You can install the development version of otter from [GitHub](https://github.com/) with:
