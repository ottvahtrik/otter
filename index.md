...
Currently otter provides
[`rtf_to_df()`](https://ottvahtrik.github.io/otter/reference/rtf_to_df.md),
which parses RTF files and extracts embedded tables into a data frame.
It automatically detects header rows, handles multi-page and multi-table
RTF output, and supports non-UTF-8 encodings.
...
[`rtf_to_df()`](https://ottvahtrik.github.io/otter/reference/rtf_to_df.md)
reads an RTF table and returns its contents as a data frame:
